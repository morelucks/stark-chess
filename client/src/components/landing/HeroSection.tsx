        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-8">
            <button
              ...
              className="px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 rounded-lg font-semibold transition transform hover:scale-105 active:scale-95 shadow-lg shadow-purple-500/20 flex items-center justify-center gap-2"
            >
              Start Playing Now
